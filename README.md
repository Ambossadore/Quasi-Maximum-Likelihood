...
This module contains the codebase for applied Quasi-Maximum Likelihood estimation of partially observed affine and polynomial processes. This includes:

- A class `KalmanFilter` for optimal discrete-time linear filtering of partially observed polynomial processes
- A base class `PolynomialModel` for calculating consistent Quasi-Maximum Likelihood estimators for a given polynomial state space model
...
For further details refer to Kallsen and Richert [3] as well as Kallsen and Richert [4].
...
[3] J. Kallsen and I. Richert (2025). "Filtering of partially observed polynomial processes in discrete and continuous time". Forthcoming. <br>
[4] J. Kallsen and I. Richert (2025). "Parameter estimation for partially observed affine and polynomial processes". Forthcoming.